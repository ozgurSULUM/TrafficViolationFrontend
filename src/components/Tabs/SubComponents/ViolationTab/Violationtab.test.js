...
test('When list is empty there should be a disabled empty button in the list',() => {
...
test('When list is not empty there should not be a disabled empty button in the list', () => {
